...
STUDY_TEXTS = [
    {
        ...
        "flowread_html": '<span class="token">The</span><span class="token highlighted"> human</span><span class="token highlighted"> brain</span><span class="token"> is</span><span class="token"> a</span><span class="token"> marvel</span><span class="token"> of</span><span class="token"> biological</span><span class="token"> engineering</span><span class="token">,</span><span class="token highlighted"> containing</span><span class="token"> approximately</span><span class="token"> </span><span class="token">8</span><span class="token">6</span><span class="token"> billion</span><span class="token highlighted"> neurons</span><span class="token highlighted"> interconnected</span><span class="token"> by</span><span class="token"> tri</span><span class="token">lli</span><span class="token">ons</span><span class="token"> of</span><span class="token"> synapses</span><span class="token highlighted">.</span><span class="token"> These</span><span class="token highlighted"> neural</span><span class="token highlighted"> networks</span><span class="token"> are</span><span class="token"> responsible</span><span class="token"> for</span><span class="token"> everything</span><span class="token highlighted"> from</span><span class="token"> basic</span><span class="token highlighted"> autonomic</span><span class="token"> functions</span><span class="token">,</span><span class="token"> like</span><span class="token"> breathing</span><span class="token"> and</span><span class="token"> heart</span><span class="token"> rate</span><span class="token">,</span><span class="token"> to</span><span class="token"> complex</span><span class="token"> cognitive</span><span class="token"> processes</span><span class="token"> such</span><span class="token"> as</span><span class="token"> memory</span><span class="token">,</span><span class="token"> emotion</span><span class="token">,</span><span class="token"> and</span><span class="token"> problem</span><span class="token">-</span><span class="token">solving</span><span class="token highlighted">.</span><span class="token highlighted"> Neurop</span><span class="token highlighted">lastic</span><span class="token highlighted">ity</span><span class="token">,</span><span class="token"> the</span><span class="token highlighted"> brain</span><span class="token">\'</span><span class="token">s</span><span class="token"> ability</span><span class="token"> to</span><span class="token"> reorgan</span><span class="token">ize</span><span class="token"> itself</span><span class="token"> by</span><span class="token"> forming</span><span class="token"> new</span><span class="token"> neural</span><span class="token"> connections</span><span class="token"> throughout</span><span class="token"> life</span><span class="token">,</span><span class="token"> allows</span><span class="token"> humans</span><span class="token"> to</span><span class="token"> learn</span><span class="token"> new</span><span class="token"> skills</span><span class="token">,</span><span class="token"> recover</span><span class="token"> from</span><span class="token"> injuries</span><span class="token">,</span><span class="token"> and</span><span class="token"> adapt</span><span class="token"> to</span><span class="token"> changing</span><span class="token"> environments</span><span class="token">.</span><span class="token"> This</span><span class="token"> extraordinary</span><span class="token"> adaptability</span><span class="token"> is</span><span class="token"> what</span><span class="token"> makes</span><span class="token"> our</span><span class="token"> species</span><span class="token"> so</span><span class="token"> resilient</span><span class="token"> and</span><span class="token"> capable</span><span class="token"> of</span><span class="token"> continuous</span><span class="token"> intellectual</span><span class="token"> growth</span><span class="token">.</span>',
        "questions": [
            {
    ...
    },
    {
        ...
        "flowread_html": '<span class="token">The</span><span class="token highlighted"> Industrial</span><span class="token highlighted"> Revolution</span><span class="token">,</span><span class="token"> which</span><span class="token"> began</span><span class="token"> in</span><span class="token highlighted"> Britain</span><span class="token"> in</span><span class="token"> the</span><span class="token"> late</span><span class="token"> </span><span class="token">1</span><span class="token">8</span><span class="token">th</span><span class="token"> century</span><span class="token">,</span><span class="token"> marked</span><span class="token"> a</span><span class="token"> profound</span><span class="token"> turning</span><span class="token"> point</span><span class="token"> in</span><span class="token"> human</span><span class="token"> history</span><span class="token highlighted">.</span><span class="token"> It</span><span class="token"> initiated</span><span class="token"> the</span><span class="token"> transition</span><span class="token"> from</span><span class="token"> agrarian</span><span class="token">,</span><span class="token"> handic</span><span class="token">raft</span><span class="token"> economies</span><span class="token"> to</span><span class="token"> industry</span><span class="token"> and</span><span class="token"> machine</span><span class="token"> manufacturing</span><span class="token">.</span><span class="token"> The</span><span class="token"> invention</span><span class="token"> of</span><span class="token"> the</span><span class="token"> steam</span><span class="token"> engine</span><span class="token">,</span><span class="token"> pioneered</span><span class="token"> by</span><span class="token"> figures</span><span class="token"> like</span><span class="token"> James</span><span class="token"> Watt</span><span class="token">,</span><span class="token"> dramatically</span><span class="token"> increased</span><span class="token"> the</span><span class="token"> efficiency</span><span class="token"> of</span><span class="token"> factories</span><span class="token"> and</span><span class="token"> transportation</span><span class="token">,</span><span class="token"> revolution</span><span class="token">izing</span><span class="token"> the</span><span class="token"> textile</span><span class="token"> industry</span><span class="token"> and</span><span class="token"> leading</span><span class="token"> to</span><span class="token"> the</span><span class="token"> expansion</span><span class="token"> of</span><span class="token"> railways</span><span class="token">.</span><span class="token"> This</span><span class="token"> era</span><span class="token"> brought</span><span class="token"> about</span><span class="token"> unprecedented</span><span class="token"> economic</span><span class="token"> growth</span><span class="token"> and</span><span class="token"> urbanization</span><span class="token">,</span><span class="token"> fundamentally</span><span class="token"> altering</span><span class="token"> social</span><span class="token"> structures</span><span class="token"> and</span><span class="token"> paving</span><span class="token"> the</span><span class="token"> way</span><span class="token"> for</span><span class="token"> the</span><span class="token"> modern</span><span class="token"> capitalist</span><span class="token"> system</span><span class="token">,</span><span class="token"> despite</span><span class="token"> also</span><span class="token"> causing</span><span class="token"> significant</span><span class="token"> social</span><span class="token"> inequalities</span><span class="token"> and</span><span class="token"> poor</span><span class="token"> working</span><span class="token"> conditions</span><span class="token"> initially</span><span class="token">.</span>',
        "questions": [
            {
